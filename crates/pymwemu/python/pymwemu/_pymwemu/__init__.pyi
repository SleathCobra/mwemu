...
class Emu:
    ...
    def load_code_bytes(self, bytes: typing.Sequence[builtins.int]) -> None:
        ...
        """
    def alloc(self, name: builtins.str, size: builtins.int) -> builtins.int:
        r"""
        allocate a buffer on the emulated process address space.
        """
    def alloc_at(self, name: builtins.str, addr: builtins.int, size: builtins.int) -> None:
        r"""
    ...
    def run_until_apicall(self) -> tuple[builtins.int, builtins.str]:
        ...
        """
    def on_memory_read(self, callback: typing.Any) -> None: ...
    def on_memory_write(self, callback: typing.Any) -> None: ...
    def on_interrupt(self, callback: typing.Any) -> None: ...
    def on_winapi_call(self, callback: typing.Any) -> None: ...
    def on_pre_instruction(self, callback: typing.Any) -> None: ...
    def on_post_instruction(self, callback: typing.Any) -> None: ...
